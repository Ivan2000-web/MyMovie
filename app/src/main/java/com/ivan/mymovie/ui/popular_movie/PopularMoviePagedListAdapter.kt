...
import com.ivan.mymovie.ui.single_movie_details.SingleMovie
...
class PopularMoviePagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie?, context: Context) {
            ...
            itemView.cv_movie_release_date.text =  movie?.birthday



            val moviePosterURL = POSTER_BASE_URL + movie?.profile_path
